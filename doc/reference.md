...
This macro extends `__init__` to allow a series of blocks to be executed when a module is initialised. The actual `__init__` function must not be defined when using `@atinit`.
